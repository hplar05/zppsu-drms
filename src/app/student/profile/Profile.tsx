      ...
      <Card className="mb-2 dark:bg-[#18191A]">
        ...
        <CardContent>
          <p>
            ...
            personal information through advanced encryption and secure access
            controls. We ensure that only authorized users can access your data,
            safeguarding it from unauthorized use or breaches. Your data remains
            private and secure at every step of its storage and transmission.
          </p>
        </CardContent>
      </Card>
